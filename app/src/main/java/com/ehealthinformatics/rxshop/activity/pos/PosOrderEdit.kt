...
package com.ehealthinformatics.rxshop.activity.pos
...
import com.ehealthinformatics.odoorx.rxshop.data.adapter.ProductSugestionsAdapter
...
//    }
    ...
    private fun initVars() {
        ...
        productSugestionsAdapter = ProductSugestionsAdapter(this, RxShop.getDao(ProductDao::class.java))
        posOrder.setUIValues()
    }
