...
import com.ehealthinformatics.odoorx.rxshop.config.StartupConfig;
import com.ehealthinformatics.odoorx.rxshop.base.account.OdooUserAskPassword;
import com.ehealthinformatics.rxshop.dialog.OdooUserObjectUpdater;
...
import com.ehealthinformatics.odoorx.rxshop.base.support.addons.fragment.IBaseFragment;
import com.ehealthinformatics.odoorx.core.base.support.drawer.ODrawerItem;
import com.ehealthinformatics.odoorx.core.base.support.sync.SyncUtils;
import com.ehealthinformatics.odoorx.core.base.utils.BitmapUtils;
import com.ehealthinformatics.odoorx.core.base.utils.OAlert;
...
import com.ehealthinformatics.odoorx.core.base.utils.OFragmentUtils;
import com.ehealthinformatics.odoorx.core.base.utils.OPreferenceManager;
import com.ehealthinformatics.odoorx.core.base.utils.OResource;
import com.ehealthinformatics.odoorx.rxshop.base.utils.drawer.DrawerUtils;
import com.ehealthinformatics.odoorx.core.base.utils.sys.IOnActivityResultListener;
import com.ehealthinformatics.odoorx.core.base.utils.sys.IOnBackPressListener;
...
public class OdooActivity extends OdooCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        rxShop = (RxShop) getApplicationContext();
    ...
    private void validateUserObject() {
        if (OdooAccountManager.anyActiveUser(this)) {
            ...
            StartupConfig.onStartup(RxShop.getAppContext(), user);
