...
import com.ehealthinformatics.rxshop.activity.utils.ShareUtil;
...
public class CustomerDetails extends OdooCompatActivity
    ...
    private CustomerList.Type partnerType = CustomerList.Type.Customer;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (hasRecordInExtra())
            partnerType = CustomerList.Type.valueOf(extras.getString(KEY_PARTNER_TYPE));
        if (!hasRecordInExtra())
            mEditMode = true;
        setupToolbar();
    }
