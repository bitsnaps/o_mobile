...
import com.ehealthinformatics.odoorx.rxshop.data.adapter.SyncModelsListAdapter;
...
import com.ehealthinformatics.rxshop.utils.LineItemDecoration;
...
public class SyncModelList extends BaseFragment implements ISyncStatusObserverListener, SwipeRefreshLayout.OnRefreshListener, View.OnClickListener {
    ...
    private void setupView() {
        irModel = RxShop.getDao(IrModel.class);
