...
import com.ehealthinformatics.data.db.Columns.SyncModel
...
class SyncModel(var id: Int, var modelName: String, var authority: String,
                ...
                var status: String, var statusDetail: String, var lastSynced: Date, var parent: com.ehealthinformatics.data.dto.SyncModel?,
                private var children: ArrayList<com.ehealthinformatics.data.dto.SyncModel>, var pullToDeviceIds: Set<Integer>, var pushToServerIds: Set<Integer>) : DTO{
    ...
    fun addChild(syncModel: com.ehealthinformatics.data.dto.SyncModel){
        children.add(syncModel)
    }

    fun getChildren(): Iterator<com.ehealthinformatics.data.dto.SyncModel>{
