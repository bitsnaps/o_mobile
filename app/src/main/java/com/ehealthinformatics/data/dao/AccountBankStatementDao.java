...
import com.ehealthinformatics.data.db.Columns.AccountBankStatementCol.State;
...
public class AccountBankStatementDao extends OModel {
    ...
    public void initDaos() {
        ...
        journalDao = App.getDao(AccountJournalDao.class);
        accountBankStatementCashBoxDao = App.getDao(AccountBankStatementCashBoxDao.class);
    }
