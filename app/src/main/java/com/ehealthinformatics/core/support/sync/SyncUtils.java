 ...
 */
package com.ehealthinformatics.core.support.sync;
...
public class SyncUtils {
    ...
    public void requestSync(String authority) {
        ...
        bundle.putString(OSyncAdapter.SYNC_MODE, Columns.SyncModel.Mode.REFRESH_TRIGGERED.name());
        requestSync(authority, bundle);
    }
