...
import com.ehealthinformatics.widgets.slider.SliderItem;
import com.ehealthinformatics.widgets.slider.SliderPagerAdapter;
...
//        items.add(new SliderItem("title", "content", R.drawable.image_shop_2, new SliderPagerAdapter.SliderBuilderListener(){
//
//            @Override
