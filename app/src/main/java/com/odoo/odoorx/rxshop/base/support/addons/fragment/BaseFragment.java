 ...
 */
package com.odoo.odoorx.rxshop.base.support.addons.fragment;
...
import com.odoo.rxshop.activity.OdooActivity;
import com.odoo.odoorx.rxshop.R;
import com.odoo.odoorx.core.base.orm.OModel;
import com.odoo.odoorx.core.base.service.receivers.ISyncFinishReceiver;
...
public abstract class BaseFragment extends Fragment implements IBaseFragment {
    ...
    private SwipeRefreshLayout noItemRefresh = null;
    ...
    public boolean inNetWork() {
        RxShop rxShop = (RxShop) mContext.getApplicationContext();
        return rxShop.inNetWork();
    }
    ...
    public void setHasFloatingButton(View view, int res_id, RecyclerView recyclerView,
...
//                mFab.listenTo(list);
    ...
    public void setHasFilterButton(View view, int res_id, RecyclerView recyclerView,
                                     View.OnClickListener clickListener) {
        mFab = (FloatingActionButton) view.findViewById(res_id);
        if (mFab != null) {
//            if (list != null)
