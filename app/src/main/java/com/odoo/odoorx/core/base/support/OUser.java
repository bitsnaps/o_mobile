 ...
 */
package com.odoo.odoorx.core.base.support;
...
import com.odoo.odoorx.core.base.rpc.helper.utils.OBundleUtils;
...
public class OUser {
    ...
    private String username, name, timezone, avatar, database, host, password, currencySymbol = "#";
