...
public class OSQLite extends SQLiteOpenHelper {
    ...
    public String databaseLocalPath() {
        ...
        return Environment.getDataDirectory().getPath() +
                "/data/" + packageName + "/databases/" + getDatabaseName();
    }
