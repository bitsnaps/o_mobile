...
//        oDomain.add("date_order", ">=", "2019-10-25 12:43:26")
    ...
    override fun initDaos() {
        ...
        posOrderLineDao = daoRepo.getDao(PosOrderLineDao::class.java)
        companyDao = daoRepo.getDao(ResCompany::class.java)
        partnerDao = daoRepo.getDao(ResPartner::class.java)
        sessionDao = daoRepo.getDao(PosSessionDao::class.java)
        ...
        var productDao = daoRepo.getDao<ProductDao>(ProductDao::class.java)
    }
