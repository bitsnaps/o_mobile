...
import com.odoo.odoorx.core.base.orm.fields.types.*
...
import com.odoo.odoorx.core.data.dto.AccountInvoice
import com.odoo.odoorx.core.data.dto.AccountInvoiceLine
...
//    internal var location_id = OColumn("Location", OInteger::class.java)//Location
    ...
    override fun initDaos() {
        ...
        productDao = daoRepo.getDao<ProductDao>(ProductDao::class.java)
        companyDao = daoRepo.getDao(ResCompany::class.java)
        partnerDao = daoRepo.getDao(ResPartner::class.java)
        accountDao = daoRepo.getDao(AccountDao::class.java)
        currencyDao = daoRepo.getDao(ResCurrency::class.java)
        userDao = daoRepo.getDao(ResUsers::class.java)
    }
...
//        posOrder.id = insert(posOrder.toOValues())
//
//        val posOrderLineDao = daoRepo.getDao<PosOrderLineDao>(PosOrderLineDao::class.java)
