...
public class ServerDataHelper {
    ...
    public OdooResult read(OdooFields fields, int id) {
        if (inNetWork()) {
            OdooResult result = mOdoo
                    .withRetryPolicy(OConstants.RPC_REQUEST_TIME_OUT, OConstants.RPC_REQUEST_RETRIES)
