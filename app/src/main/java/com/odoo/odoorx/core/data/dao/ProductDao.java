...
import com.odoo.odoorx.core.base.utils.ImageUtils;
...
public class ProductDao extends OModel {
    ...
    public static final String AUTHORITY = BuildConfig.APPLICATION_ID +
            ".base.provider.content.sync.product_product";
...
//        oDomain.add("name", "=", "Faded SkyBlu Denim Jeans");
    ...
    public void initDaos() {
       DaoRepoBase daoRepo = DaoRepoBase.getInstance();
        super.initDaos();
        productTemplateDao = daoRepo.getDao(ProductTemplateDao.class);
        medicineDao = daoRepo.getDao(MedicineDao.class);
    }
