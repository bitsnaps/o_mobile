...
import com.odoo.odoorx.core.base.utils.sys.OCacheUtils;
...
public class OdooAccountManager {
    ...
    public static final String KEY_ACCOUNT_TYPE = "com.odoo.odoorx.core.auth";
    ...
    public static boolean removeAccount(Context context, String username) {
        ...
        if (user != null) {
            ...
            Log.d(TAG, "user is null at removeAccount(), username: " + username);
        }
        return false;
    }
    ...
    public static void dropDatabase(Context context, OUser user) {
        ...
        if (user == null) {
            ...
            //    java.lang.NullPointerException: Attempt to invoke virtual method 'com.odoo.odoorx.core.base.orm.OSQLite com.odoo.odoorx.core.data.dao.DaoRepoBase.getSQLite(java.lang.String)' on a null object reference
            OSQLite sqLite = daoRepo.getSQLite(user.getAndroidName());
            if (sqLite != null) {
                sqLite.dropDatabase();
                daoRepo.setSQLite(user.getAndroidName(), null);
            }
        }
    ...
    public static OUser login(Context context, String username) {
        ...
        OdooLog.d("Logging out username: " + username);
        if (activeUser != null) {
