...
import com.odoo.odoorx.core.base.auth.IConfigLoadListener;
...
import com.odoo.odoorx.core.base.auth.ILoginProgressStatus;
...
import com.odoo.odoorx.rxshop.base.support.OdooUserLoginSelectorDialog;
...
public class OdooLogin extends AppCompatActivity implements View.OnClickListener,
    ...
    private void loginUser() {
        ...
        if (databases.isEmpty()){
            Toast.makeText(this, OResource.string(this, R.string.error_cannot_find_database), Toast.LENGTH_LONG).show();
            return;
        }
        if(validate()) {
            ...
            if (mConnectedToServer) {
                if (databaseSpinner != null) {
                    databases = userAccount.getDatabases();
                    if (!databases.isEmpty()){
    ...
    private void initServers(){
        ArrayAdapter<String> servereAdapter = new ArrayAdapter<String>(this, android.R.layout.simple_list_item_1,
                Arrays.asList(OConstants.ODOO_DATABASES.split(",")));
