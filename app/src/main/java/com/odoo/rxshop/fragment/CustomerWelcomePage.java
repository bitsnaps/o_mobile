...
import com.odoo.odoorx.rxshop.data.adapter.AdvertismentListAdapter;
...
import com.odoo.odoorx.core.data.viewmodel.CustomerOrderViewModel;
...
//        SearchView notificationLayout = (SearchView) MenuItemCompat.getActionView(cartCount);
        RelativeLayout notificationLayout = (RelativeLayout) MenuItemCompat.getActionView(cartCount);
        TextView tv = (TextView) notificationLayout.findViewById(R.id.tv_cart_count);
        tv.setText("12");
    }
